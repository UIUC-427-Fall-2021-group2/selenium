...
import org.openqa.selenium.devtools.v93.fetch.model.AuthChallengeResponse;
import org.openqa.selenium.devtools.v93.fetch.model.AuthRequired;
...
import org.openqa.selenium.devtools.v93.fetch.model.RequestPaused;
...
public class V93Network extends Network<AuthRequired, RequestPaused> {
  ...
  protected Command<Void> setUserAgentOverride(UserAgent userAgent) {
    return org.openqa.selenium.devtools.v93.network.Network.setUserAgentOverride(
      userAgent.userAgent(), userAgent.acceptLanguage(), userAgent.platform(), Optional.empty());
  }

  @Override
  protected Command<Void> enableNetworkCaching() {
    return org.openqa.selenium.devtools.v93.network.Network.setCacheDisabled(false);
  }

  @Override
  protected Command<Void> disableNetworkCaching() {
    return org.openqa.selenium.devtools.v93.network.Network.setCacheDisabled(true);
  }
